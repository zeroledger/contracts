...
library InputsLib {
    ...
    function fillSpend3Inputs(Transaction calldata transaction)
        external
        pure
    ...
    function fillSpend4Inputs(Transaction calldata transaction)
        external
        pure
    ...
    function fillSpend5Inputs(Transaction calldata transaction)
        external
        pure
    ...
    function fillSpend6Inputs(Transaction calldata transaction)
        external
        pure
    ...
    function fillSpend18Inputs(Transaction calldata transaction)
        external
        pure
